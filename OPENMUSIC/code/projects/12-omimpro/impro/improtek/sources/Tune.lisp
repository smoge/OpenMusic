...
(defclass* tune ()
  (
   ...
   ;Jerome 26/10/13 : New fields for real time improvisation (move ?) ! YES IT MOVED !!!!!
   ; NEW CLASSES DEFINED IN """AsynchEventDrivenProdCons.lisp""".......
   ;----------------------------------------------------------------------------------------------------------
   #|
   ...
   ;----------------------------------------------------------------------------------------------------------
   ;
   (RealtimeImprovizer-in-OSC-env :initform nil :initarg :RealtimeImprovizer-in-OSC-env :accessor RealtimeImprovizer-in-OSC-env)
   ))
...
;;;;; -----------------------------------------------------------------------------------
;;;;; -----------------------------------------------------------------------------------
;EST PASSE UN TEMPS PAR ANTESCOFOTR.LISP, ET MAINTENANT DEPLACE DANS ANTESCOFO.LISP ?????
; ((((sous le nom de BEAT-AS-sring-group.....
;;;;; -----------------------------------------------------------------------------------
;;;;; -----------------------------------------------------------------------------------
