...
(defmethod TransposeLabel ((self label) delta) self)
(defmethod TransformLabel ((self label) delta) (TransposeLabel self delta))
...
(defmethod TransposeData ((self data) delta) self)
(defmethod TransformData ((self data) delta) (TransposeData self delta))
