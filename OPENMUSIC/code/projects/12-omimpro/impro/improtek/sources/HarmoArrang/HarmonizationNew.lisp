...
(pgmout 4 1) 
(pgmout 4 2)
(setf mix (merger (beats->chseq beatlist-input-melo beatdur-input-melo 0) (beats->chseq accomp beatdur-input-melo 0)))
...
(setf mix (merger (beats->chseq beatlist-input-melo Dicidenbas_beatdur 0) (beats->chseq accomp Dicidenbas_beatdur 0)))
(Stop-Player *general-player*)
(play mix)
|#
...
(defun chseq-mix-melo-accomp (beatlist-melo beatlist-accomp beatdur chan-melo chan-accomp)
  (let ((melo beatlist-melo) (accomp beatlist-accomp))
    ...
    (merger (beats->chseq melo beatdur 0) (beats->chseq accomp beatdur 0))))
...
(defun save-as-midi-mix-melo-accomp-midifile (beatlist-melo beatlist-accomp beatdur chan-melo chan-accomp absolute-path-filename)
  ...
  ;  (save-as-midi-with-tempo (beats->chseq mix beatdur 0) beatdur absolute-path-filename)))
