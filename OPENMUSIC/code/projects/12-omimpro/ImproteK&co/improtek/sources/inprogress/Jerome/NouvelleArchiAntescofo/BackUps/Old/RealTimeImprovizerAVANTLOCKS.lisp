...
(defclass* realTime-improvizer (improvizer)
   (
    ...
    (lock :initform nil :initarg :lock :accessor lock)
    ))
...
;06/08/2013
;*#*#*#*#*#*#*#*# ATOMIC !!! *#*#*#*#*#*#*#*#
;ATOMIC FUNCALL POUR NE PAS AVOIR DE PROBLEME AVEC ERITURE ET LECTURE SIMULTANEE !!!!!
;*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#*#
#|
(defmethod learn-event ((self realTime-improvizer) (event event))
(call-next-method))
(defmethod learn-event ((self realTime-improvizer) (event t))   ; for genericity, when event is a non 'Beat' event (t is for other types)
(call-next-method))
