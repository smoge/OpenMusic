...
;(progn
      ...
      (setf (gethash oracle_melo_harm_name *available-MeloHarmOracles*) (load-improvizer save_path_oracle_melo_harmo))
      (setf (gethash oracle_voicings_name *available-VoicingsOracles*) (load-improvizer save_path_oracle_voicings))
      (format *om-stream* "========= IMPROVIZERS DANS HASH TABLE ========= ~%")
;)
