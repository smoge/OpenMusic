...
(set-start-point garnerrightoracle 50)             ; -------> change this value to obtain various improvisations
...
(defmethod TransposeLabel ((label garnerlabel) int)  
...
(harmlabel (nth 1 g))
(harmlabel (TransposeLabel (nth 0 labels2) -1))
